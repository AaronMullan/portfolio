...
const cardData = [
  ...
  },
  {
    title: 'Climatizor',
    text:
      'Simple notifications app using the New York Times API and localstorage',
    link: 'http://www.shavedave.org/',
    image: notifizor,
    linkText: 'site',
    secondaryLink: 'https://github.com/AaronMullan/notifizor/tree/main/src',
  },
  {
